...
public class ExampleScene implements Scene {
    ...
    public void initialize(RenderTarget target) throws Exception {
        ...
        nakadaiFont.loadFromStream(
                getClass().getResourceAsStream("src/main/resources/Nakadai.ttf"));

        freeSansFont.loadFromStream(
                getClass().getResourceAsStream("src/main/resources/FreeSans.ttf"));
        ...
        if (Shader.isAvailable()) {
            ...
            waveXShader.loadFromStream(
                    getClass().getResourceAsStream("src/main/resources/wave-x.frag"), Shader.Type.FRAGMENT);
